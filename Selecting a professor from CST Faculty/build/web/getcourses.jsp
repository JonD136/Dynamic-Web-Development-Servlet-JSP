...
<%
    try {
        ...
        String fileName = "C:/Users/diazj/Downloads/cst_faculty_sp2019.csv";
        ...
        if (ins == null) out.println("File not Found");
            ...
            if (foundprof == true) out.println("Professor: " + pName + "<br/>"
                        + "<br/>Courses:<br/><ul>" + courses + "</ul>");
            
            else  out.println("Professor not found");
